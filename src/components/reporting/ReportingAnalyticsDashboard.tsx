...
export function ReportingAnalyticsDashboard() {
  ...
  const typeEntries = Object.entries(analytics.executionsByType);
  ...
  const stats = [
    ...
    { label: 'Active', value: analytics.activeReports },
    { label: 'Scheduled', value: analytics.scheduledReports },
  ...
  return (
    <div className="space-y-6">
      ...
      {typeEntries.length > 0 && (
        <div>
          <h3 className="mb-2 text-sm font-medium">Reports by Type</h3>
          <svg width={barWidth + 120} height={svgHeight} role="img" aria-label="Reports by type chart">
